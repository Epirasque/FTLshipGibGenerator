...
PARAMETERS = collections.namedtuple("PARAMETERS",
                                    """INPUT_AND_STANDALONE_OUTPUT_FOLDERPATH ADDON_OUTPUT_FOLDERPATH SHIPS_TO_IGNORE OUTPUT_MODE BACKUP_SEGMENTS_FOR_DEVELOPER BACKUP_LAYOUTS_FOR_DEVELOPER NR_GIBS_PLAYER NR_GIBS_BOSS NR_GIBS_NORMAL_ENEMY QUICK_AND_DIRTY_SEGMENT GENERATE_METAL_BITS ANIMATE_METAL_BITS_FOR_DEVELOPER ANIMATE_METAL_BITS_FPS CHECK_SPECIFIC_SHIPS SPECIFIC_SHIP_NAMES LIMIT_ITERATIONS ITERATION_LIMIT     IMPLODE IMPLODE_SPEED_FACTOR LOWER_BOUND_VELOCITY UPPER_BOUND_VELOCITY TOTAL_DIRECTION_SPREAD_IN_DEGREES MAXIMUM_ANGULAR_SPREAD_IN_DEGREES LAYER1_ANGLE_TOLERANCE_SPREAD_FOR_TILE_RANDOM_SELECTION LAYER2_ANGLE_TOLERANCE_SPREAD_FOR_TILE_RANDOM_SELECTION LAYER3_ANGLE_TOLERANCE_SPREAD_FOR_TILE_RANDOM_SELECTION STARTING_COMPACTNESS COMPACTNESS_GAIN_PER_ATTEMPT COMPACTNESS_LIMIT MAXIMUM_DEVIATION_FROM_BASE_IMAGE_PERCENTAGE MINIMAL_WEIGHTED_SEGMENT_RATIO SHADING_MINIMUM_WEIGHT_OF_SHIP_COLOR_AGAINST_TILE_COLOR SHADING_MAXIMUM_WEIGHT_OF_SHIP_COLOR_AGAINST_TILE_COLOR""")
...
def determineParameters():
    ...
    LAYER2_ANGLE_TOLERANCE_SPREAD_FOR_TILE_RANDOM_SELECTION = coreConfig.getint(
        'LAYER2_ANGLE_TOLERANCE_SPREAD_FOR_TILE_RANDOM_SELECTION', fallback=15)
    ...
    SHADING_MINIMUM_WEIGHT_OF_SHIP_COLOR_AGAINST_TILE_COLOR = coreConfig.getfloat(
        'SHADING_MINIMUM_WEIGHT_OF_SHIP_COLOR_AGAINST_TILE_COLOR', fallback=.3)
    SHADING_MAXIMUM_WEIGHT_OF_SHIP_COLOR_AGAINST_TILE_COLOR = coreConfig.getfloat(
        'SHADING_MAXIMUM_WEIGHT_OF_SHIP_COLOR_AGAINST_TILE_COLOR', fallback=.6)
    ...
    return PARAMETERS(INPUT_AND_STANDALONE_OUTPUT_FOLDERPATH, ADDON_OUTPUT_FOLDERPATH, SHIPS_TO_IGNORE,
                      ...
                      BACKUP_LAYOUTS_FOR_DEVELOPER, NR_GIBS_PLAYER, NR_GIBS_BOSS, NR_GIBS_NORMAL_ENEMY, QUICK_AND_DIRTY_SEGMENT,
                      ...
                      LAYER2_ANGLE_TOLERANCE_SPREAD_FOR_TILE_RANDOM_SELECTION,
