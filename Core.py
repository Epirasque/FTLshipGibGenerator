...
def determineParameters():
    ...
    BACKUP_STANDALONE_SEGMENTS_FOR_DEVELOPER = coreConfig.getboolean('BACKUP_STANDALONE_SEGMENTS_FOR_DEVELOPER', fallback=False)
    BACKUP_STANDALONE_LAYOUTS_FOR_DEVELOPER = coreConfig.getboolean('BACKUP_STANDALONE_LAYOUTS_FOR_DEVELOPER', fallback=False)
